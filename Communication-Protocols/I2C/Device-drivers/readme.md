...
- [LM75](LM75.f), Temperature sensor with 9-bit resolution and max. +-2 degree celcius accuracy [datasheet](https://datasheets.maximintegrated.com/en/ds/LM75.pdf) & examples:
```
